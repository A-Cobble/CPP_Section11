...
//The & symbol represents pass by reference. 
//This means that it refers to the actual value/ actual location of the parameter and doesn't create a copy of the parameter
